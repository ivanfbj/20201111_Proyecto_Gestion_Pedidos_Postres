...
// Todo este este bloque de comentareado, es una forma de agilizar las pruebas unitarias del proyecto.
// Se dejan comentareadas en caso de realizar pruebas en actualizaciones del proyecto
/*
		Cliente cliente0 = new Cliente("Ivan", "Cra 40", 2701234, "Masculino", 27);
		GuiRegistrarCliente.cliente.add(cliente0);
