...
public class PostreRefrigerado extends Postre {
    ...
    public String toString() {
        return super.toString()+ "PostreRefrigerado{" + "temperaturaMantenimiento=" + temperaturaMantenimiento + ", tiempoMaximoSinRefrigeracionHoras=" + tiempoMaximoSinRefrigeracionHoras ;
    }
